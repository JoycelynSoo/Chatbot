export type AnnotationEditorUIManager = import("pdfjs-dist/types/src/display/editor/tools").AnnotationEditorUIManager;
export type PageViewport = import("pdfjs-dist/types/src/display/display_utils").PageViewport;
export type TextAccessibilityManager = import("pdfjs-dist/types/web/text_accessibility").TextAccessibilityManager;
export type IL10n = import("pdfjs-dist/types/web/interfaces").IL10n;
export type AnnotationLayer = import("pdfjs-dist/types/src/display/annotation_layer").AnnotationLayer;
export type DrawLayer = import("pdfjs-dist/types/src/display/draw_layer").DrawLayer;
export type AnnotationEditorLayerOptions = {
    mode: Object;
    div: HTMLDivElement;
    uiManager: AnnotationEditorUIManager;
    enabled: boolean;
    accessibilityManager?: import("pdfjs-dist/types/web/text_accessibility").TextAccessibilityManager | undefined;
    pageIndex: number;
    l10n: IL10n;
    annotationLayer?: import("pdfjs-dist/types/src/display/annotation_layer").AnnotationLayer | undefined;
...
export class AnnotationEditorLayer {
    ...
    pageIndex: number;
    div: HTMLDivElement;
    viewport: import("pdfjs-dist/types/src/display/display_utils").PageViewport;
    drawLayer: import("pdfjs-dist/types/src/display/draw_layer").DrawLayer;
    get isEmpty(): boolean;
...
import { AnnotationEditor } from "pdfjs-dist/types/src/display/editor/editor";
import { FreeTextEditor } from "pdfjs-dist/types/src/display/editor/freetext";
import { HighlightEditor } from "pdfjs-dist/types/src/display/editor/highlight";
import { InkEditor } from "pdfjs-dist/types/src/display/editor/ink";
import { StampEditor } from "pdfjs-dist/types/src/display/editor/stamp";
